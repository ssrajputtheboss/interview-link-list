                                    ...
                                    return Stack(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(state.currentServer,style: TextStyle(color: Colors.white,shadows: [Shadow(color: Colors.black,offset: Offset(1,1),blurRadius: 2),],fontWeight: FontWeight.bold,fontSize: 20),),
                                        )
                                      ],
                                    );
                                  }
                                        ...
                                        children: [
                                          Expanded(
                                              child: TextButton(
                                                ...
                                                child:Text('# '+_channels[i].replaceAll('_','-'),overflow: TextOverflow.ellipsis,style: TextStyle(wordSpacing: 2,color: Colors.white54,fontSize: 20,fontFamily: "Arial",decoration: _channels[i]==state.currentChannel? TextDecoration.underline:TextDecoration.none,decorationStyle: TextDecorationStyle.double))
                                                ,onPressed: (){
